...
//
const BotName = 'BOT ./MUDY'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/m.hadination_/'; // Nama Instagramlu cok
const whatsapplu = '0857-5164-7926'; // Nomor whatsapplu cok
